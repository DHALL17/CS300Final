...
void setHolding(Process *p, int dirty, int address, double block)
{
    p->diskRequest[0] = dirty;
    p->diskRequest[1] = address;
    p->diskRequest[2] = block;
}
